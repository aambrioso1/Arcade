...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        # Sounds:  Need a wav sound file:  "sounds/laser1.wav"
        self.laser_sound = arcade.load_sound("sounds/lasersound.wav")
    ...
    def start_new_game(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = ShipSprite("images/spaceship.png", SCALE)
        """
        Need a ship pgn image: "images/playerShip1_orange.png"
        """
        ...
        for i in range(self.lives):
            life = arcade.Sprite("images/lifeimage.png", SCALE)
            """
            Need a ship pgn image: "images/lifeimage.png"
            """
        ...
        # Make the asteroids
        image_list = ("images/asteroid_big.png",
                      "images/asteroid_big.png",
                      "images/asteroid_big.png",
                      "images/asteroid_big.png")
        """
        Need 4 pgn image files for meteors: "images/meteorGrey_big1.png",
    ...
    def on_key_press(self, symbol, modifiers):
        ...
        if not self.player_sprite.respawning and symbol == arcade.key.SPACE:
            """
            Need a laser png file:  "images/laserRed.png"
            """
            bullet_sprite = BulletSprite("images/laserRed.png", SCALE)
    ...
    def split_asteroid(self, asteroid: AsteroidSprite):
        ...
        if asteroid.size == 4:
            for i in range(3):
                ...
                image_list = ["images/asteroid_medium.png",
                              "images/asteroid_medium.png"]
                """
                Need two png image files for medium size meteors.
                """
            ...
            for i in range(3):
                image_no = random.randrange(2)
                image_list = ["images/asteroid_small.png",
                              "images/asteroid_small.png"]
                """
                Need two png image files for small size asteroids.
                """
            ...
            for i in range(3):
                image_no = random.randrange(2)
                image_list = ["images/asteroid_tiny.png",
                              "images/asteroid_tiny.png"]
                """
                Need two png image files for tiny asteroids."
                """
                enemy_sprite = AsteroidSprite(image_list[image_no],
                                              SCALE * 1.5)
